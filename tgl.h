...
TGL_EXPORT tgl_context*
tglContextCreate(int xsize,  int ysize,  int depth,
                 void **framebuffers, int numbuffers);

TGL_EXPORT void
tglContextDelete(tgl_context *context);

TGL_EXPORT void
tglContextMakeCurrent(tgl_context *context, int index);
